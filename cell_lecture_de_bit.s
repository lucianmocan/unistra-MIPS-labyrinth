...
sw $a1 8($sp) # l'entier n dont on veut changer le n-iÃ¨me bit -> $a1
#corps
jal pow_2 # fonction qui calcule la n($a0)-iÃ¨me puissance de 2
move $t0 $v0 # puissance de 2, le seul a bit Ã  1 est le n-iÃ¨me
or $v0 $a1 $t0  # on met le n($a0)-iÃ¨me bit Ã  1 
#epilogue
lw $ra 0($sp)
lw $a0 4($sp)
lw $a1 8($sp)
...
sw $a1 8($sp) # l'entier n dont on veut changer le n-iÃ¨me bit -> $a1
#corps
jal function_bis # fonction qui retourne un entier ou le seul bit Ã  0 est le n-iÃ¨me
and $v0 $v0 $a1 # met le n-iÃ¨me bit Ã  0
#epilogue
lw $ra 0($sp)
lw $a0 4($sp)
lw $a1 8($sp)
